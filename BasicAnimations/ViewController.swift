...
//  BasicAnimations
//
//  Created by Dongwoo Pae on 6/24/19.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() { //this gets called before subviews are layed out -  it might crash
        super.viewDidLoad()
    ...
    override func viewDidAppear(_ animated: Bool) { //better place to call this because we know that subviews are layout
        super.viewDidAppear(animated)
        //this ensure the label is centered
...
//                                                    multiplier: 1,
//                                                    constant: 100)
//        let redAspectRatioContraint = NSLayoutConstraint(item: redView,
//                                                          attribute: .width,
//                                                          relatedBy: .equal,
//                                                          toItem: redView,
//                                                          attribute: .height,
...
//                                                          constant: 0)
    ...
    //MARK: - Actions and Animations  // we are going to use animation block
    ...
    @objc func squashButtonTapped() {
        label.center = CGPoint(x: view.center.x, y: -label.bounds.size.height)  //this will make the label off of this view
